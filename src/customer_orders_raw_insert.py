...
task_customer_landing_to_processing = BashOperator(
 ...
 bash_command='aws s3 mv s3://ecommerce-pipeline-faizan-2024/customers/landing/ s3://ecommerce-pipeline-faizan-2024/customers/processing/{0}/ --recursive'.format(batch_id),
 dag=dag
)
 
task_customers_processing_to_processed = BashOperator(
 task_id="customer_processing_to_processed",
 bash_command='aws s3 mv s3://ecommerce-pipeline-faizan-2024/customers/processing/{0}/ s3://ecommerce-pipeline-faizan-2024/customers/processed/{0}/ --recursive'.format(batch_id),
 dag=dag
)
 
task_orders_landing_to_processing = BashOperator(
 task_id="orders_landing_to_processing",
 bash_command='aws s3 mv s3://ecommerce-pipeline-faizan-2024/orders/landing/ s3://ecommerce-pipeline-faizan-2024/orders/processing/{0}/ --recursive'.format(batch_id),
 dag=dag
)
 
task_orders_processing_to_processed = BashOperator(
 task_id="orders_processing_to_processed",
 bash_command='aws s3 mv s3://ecommerce-pipeline-faizan-2024/orders/processing/{0}/ s3://ecommerce-pipeline-faizan-2024/orders/processed/{0}/ --recursive'.format(batch_id),
 dag=dag
)
